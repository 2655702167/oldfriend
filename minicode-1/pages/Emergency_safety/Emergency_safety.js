...
Page({
    data: {
      ...
      latitude: null,
      longitude: null,
      propertyPhone: '18350587025', // 物业联系电话
    ...
    goToNextPage(){
        // app.playText('一键报警');
        wx.navigateTo({
          url: '/pages/Safety_alarm/Safety_alarm'
        })
    },
    onMedicalHelp() {
        // app.playText('正在呼叫医疗急救');
        wx.makePhoneCall({
            phoneNumber: '120'
        });
    },
    onPropertyContact() {
        // app.playText('正在联系物业');
        wx.makePhoneCall({
			phoneNumber: this.data.propertyPhone
		});
    },
    // 呼叫自定义联系人
    callCustomContact(e) {
